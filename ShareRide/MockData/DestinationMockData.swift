...
let mockSameStartInitUsers: [User] = [
	User(id: 1, isHost: true, userName: "박지은", userImage: "UserImage1", destination: "경유지 미지정", x: "", y: "", distance: 0),
	User(id: 2, isHost: false, userName: "조예린", userImage: "UserImage2", destination: "경유지 미지정", x: "", y: "", distance: 0),
	User(id: 3, isHost: false, userName: "이지은", userImage: "UserImage3", destination: "경유지 미지정", x: "", y: "", distance: 0),
	User(id: 4, isHost: false, userName: "김예림", userImage: "UserImage4", destination: "경유지 미지정", x: "", y: "", distance: 0)
]

let mockSameDestinationInitUsers: [User] = [
	User(id: 1, isHost: true, userName: "박지은", userImage: "UserImage1", destination: "출발지 미지정", x: "", y: "", distance: 0),
	User(id: 2, isHost: false, userName: "조예린", userImage: "UserImage2", destination: "출발지 미지정", x: "", y: "", distance: 0),
	User(id: 3, isHost: false, userName: "이지은", userImage: "UserImage3", destination: "출발지 미지정", x: "", y: "", distance: 0),
	User(id: 4, isHost: false, userName: "김예림", userImage: "UserImage4", destination: "출발지 미지정", x: "", y: "", distance: 0)
]
